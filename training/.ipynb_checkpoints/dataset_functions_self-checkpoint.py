...
class DatasetTransformer:
    ...
    def keypoint_distance(self, kpt):
        ...
        if kpt[2] == tf.constant(0.0):
            ...
            ortho_dist = (self.grid * (self.LABEL_HEIGHT, self.LABEL_WIDTH) - kpt[0:2] * (self.LABEL_HEIGHT, self.LABEL_WIDTH)) / (self.LABEL_HEIGHT, self.LABEL_HEIGHT)
    ...
    def open_image(self, elem):
        ...
        if self.INPUT_TYPE == 'RGB':
            ...
            c = 4
        image = tf.image.decode_png(image_raw, channels=c)
