...
class ModelMaker:
    ...
    def _get_vgg_layer_config_weights(self):
        # read from VGG16 models and save bottom 10 layers' configs 
    ...
    def _make_vgg_input_model(self, x):
        # reconstruct bottom 10 layers of VGG16 from configs
    ...
    def _make_stage0(self, x):
        # make stem stage: conv512-conv512-conv256-conv256, no BNs
