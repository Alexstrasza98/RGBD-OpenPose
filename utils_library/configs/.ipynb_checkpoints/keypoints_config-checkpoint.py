...
#the starting and ending indexes for the center,right and left sides from KEYPOINTS_DEF above
...
#the starting and ending indexes for the center,right and left sides from JOINTS_DEF above